YUI.add('moodle-atto_mathslate-editor', function (Y, NAME) {
...
NS.Editor = function(editorID, config, params) {
    ...
    this.node.setHTML(M.util.get_string('nomathjax', 'atto_mathslate'));
    ...
    "requires": [
        ...
        "io-base",
        "json",
        "moodle-atto_mathslate-textool",
        "moodle-atto_mathslate-mathjaxeditor"
    ]
});
